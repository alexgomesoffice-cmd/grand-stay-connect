...
const SearchBar = () => {
  ...
  return (
    <div className="w-full max-w-5xl mx-auto animate-fade-in-up" style={{ animationDelay: "400ms" }}>
      <div className="glass rounded-2xl p-3 sm:p-4 shadow-2xl shadow-primary/10">
          ...
          <div className="lg:col-span-2 relative group">
            ...
            <div className="relative">
              ...
              <Input
                ...
                className="pl-12 bg-secondary/30 border-border/50 hover:border-primary/40 focus:border-primary"
              />
            </div>
          </div>
